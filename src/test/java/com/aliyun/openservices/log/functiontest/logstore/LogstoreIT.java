...
public class LogstoreIT extends FunctionTest {
    ...
    private static void deleteAll() throws Exception {
        // Both @BeforeClass and @AfterClass fan out to this. The former is
        // gated by FunctionTest.setUpCredentials(); the latter still runs after
        // an assumption violation, so guard the network call explicitly.
