...
public class ScheduledSQLIT extends FunctionTest {
    ...
    public ScheduledSQLIT() {
        super(1800000);
    }

    @Before
    public void setUp() {
        safeCreateProject(project, "ScheduledSQLIT");
        safeCreateProject(destProject, "ScheduledSQLIT dest");
