...
/**
 * The request used to get a resource policy.
 */
public class GetResourcePolicyRequest extends Request {
    private static final long serialVersionUID = 1L;

    private ResourcePolicyResourceType resourceType;
    private String resourceName;

    public GetResourcePolicyRequest(String project, ResourcePolicyResourceType resourceType,
                                    String resourceName) {
        super(project);
